...
def make_ball(x, y, size, color, ball):
    ball.hideturtle()
    ball.penup
...
def snow_fall():
    ...
    if rand_make_snow == 0:
        ...
        make_ball(random.randint(-width / 2, width / 2), width / 2, snow_size, "white", snow)
...
stem.begin_fill()
stem.setposition(width / 30, -width / 4.8)
stem.setposition(width / 30, -3 * width / 4.8)
stem.setposition(-width / 30, -3 * width / 4.8)
stem.setposition(-width / 30, -width / 4.8)
stem.end_fill()
...
# decorations: balls
screen.tracer(2)
ball_colors = ["red", "red", "red", "gold", "violet", "white"]
ball_positions = [(-width / 30, width / 4), (3 * width / 40, width / 5),
                  ...
                  (0, -width / 6), (-width / 6, -width / 6), (width / 5, -width / 7.5)]
for position in ball_positions:
    make_ball(position[0], position[1], 20 / i_scale, random.choice(ball_colors), turtle.Turtle())
    screen.update()
...
text_1.write("Merry Christmas", font=("Apple Chancery", max(int(30 / i_scale), 15), "bold"), align="center")
...
text_1.write("HarryDom2912 in 2023", font=("Apple Chancery", max(int(30 / i_scale), 15), "normal"), align="center")
